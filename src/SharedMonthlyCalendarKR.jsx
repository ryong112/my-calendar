...
export default function SharedMonthlyCalendarKR() {
  ...
  return <div className="min-h-screen bg-slate-100 text-slate-950 lg:flex lg:h-dvh lg:flex-col lg:overflow-hidden">
    <header className="shrink-0 border-b border-slate-200 bg-white">
      <div className="mx-auto flex w-full max-w-[2200px] flex-col gap-3 px-3 py-3 sm:px-4 lg:flex-row lg:items-center lg:justify-between lg:px-5 2xl:px-7">
    ...
    <main className="mx-auto w-full max-w-[2200px] px-3 py-3 sm:px-4 lg:flex lg:min-h-0 lg:flex-1 lg:flex-col lg:px-5 lg:py-3 2xl:px-7">
      ...
      <div className="grid gap-3 lg:min-h-0 lg:flex-1 lg:grid-cols-[minmax(0,1fr)_280px] xl:grid-cols-[minmax(0,1fr)_330px] 2xl:grid-cols-[minmax(0,1fr)_360px]">
